...
*Note: You'll be doing this with both legs together for ankle safety*
...
#### Cable Row Wide Grip {#cable-row-wide-grip}
**[🎯 View Exercise on Jefit](https://www.jefit.com/exercises/21/cable-seated-row)**
*Note: Use wide-grip bar attachment instead of narrow handle*
...
**[🎯 View Exercise on Jefit](https://www.jefit.com/exercises/1268/machine-lat-pulldown)**
*Note: Use close-grip attachment (V-bar or close grip)*
...
#### Rotary Torso Machine {#rotary-torso-machine}
**[🎯 View Exercise on Jefit](https://www.jefit.com/exercises/1326/machine-rotary-torso)**
...
*Note: Bodyweight version for ankle safety*
...
#### Light Walking Warmup {#light-walking-warmup}
...
#### Hip Circles and Leg Swings {#hip-circles-leg-swings}
...
#### Ankle Mobility Warmup {#ankle-mobility-warmup}
...
**Benefits:** Critical for your subtalar dislocation history, improves proprioception
...
**Critical for your ankle:** Essential for tennis return preparation
**Benefits:** Ankle stability, proprioception, injury prevention
...
**Duration:** 1-2 minutes, 10-15 cycles
**Benefits:** Spinal mobility, morning stiffness relief, core activation
...
This comprehensive exercise guide provides everything you need for safe, effective training while accommodating your ankle injury history. Each exercise includes proper form cues, progression guidelines, and direct links to Jefit for visual reference.---
title: Workout Plan
...
- **[Seated Cable Row](#seated-cable-row)** - 12-15 reps (*Start: 35-40kg*)
...
1. **[Leg Press Machine](#leg-press-machine)** - 4 sets x 8-10 reps (*Start: 70-90kg*)
   - *Both feet secure, no single-leg variations*
   - *Rest: 90 seconds between sets*

2. **Superset A (3 rounds, 75s rest):**
   - **[Leg Curl Machine](#leg-curl-machine)** - 10-12 reps (*Start: 20-25kg*)
   - **[Leg Extension Machine](#leg-extension-machine)** - 12-15 reps (*Start: 25-30kg*)

3. **Superset B (3 rounds, 60s rest):**
   - **[Seated Calf Raise](#seated-calf-raise-machine)** - 15-20 reps (*Start: 25-30kg*)
...
- [Ankle alphabet](#ankle-alphabet) - 30 seconds each foot
- [Calf stretch against wall](#standing-calf-stretch) - 30 seconds each leg
...
2. **[Rotary Torso Machine](#rotary-torso-machine)** - 2 sets x 12 each direction (*seated stability*)
...
1. **Gentle Movement Flow:**
   - [Cat-cow stretches](#cat-cow-stretch) - 2 min
   - [Child's pose to downward dog](#child-pose-to-downward-dog) - 2 min
...
### Ankle-Specific Mobility

#### Ankle Alphabet {#ankle-alphabet}
**Position:** Seated or lying, leg extended
**Movement:** Trace alphabet letters with your toe
**Focus:** Full range of motion in all directions
**Duration:** 30 seconds per foot
**Frequency:** Daily, especially pre-tennis

#### Standing Calf Stretch {#standing-calf-stretch}
**Position:** Face wall, hands against wall
**Setup:** Step back with target leg, keep heel down
**Hold:** 30-45 seconds each leg
**Progression:** Lean forward to increase stretch
**Ankle benefit:** Improves dorsiflexion range

#### Single-Leg Balance {#single-leg-balance}
**Progression Week 1-2:** Use wall support, 15-30 seconds
**Progression Week 3-4:** No support, 30-45 seconds
**Progression Week 5+:** Add head turns or arm movements
**Focus:** Ankle stability and proprioception
**Safety:** Stop immediately if any pain

### Tennis-Specific Preparation

#### Tennis-Specific Arm Swings {#tennis-specific-arm-swings}
**Movement:** Simulate forehand and backhand motions
**Focus:** Gradually increase range and speed
**Duration:** 1 minute each stroke type
**Benefit:** Shoulder preparation and movement rehearsal

#### Shadow Tennis Movements {#shadow-tennis-movements}
**Setup:** Both feet planted, no lateral movement initially
**Movements:** Service motion, groundstroke preparation
**Progression:** Add controlled steps as ankle improves
**Focus:** Movement patterns without ankle stress
**Duration:** 2-3 minutes total

### General Recovery Stretches

#### Cat-Cow Stretch {#cat-cow-stretch}
**Position:** Hands and knees on floor
**Movement:** Alternate arching and rounding spine
**Benefits:** Spinal mobility, core activation
**Duration:** 1-2 minutes, slow controlled movements

#### Child's Pose to Downward Dog {#child-pose-to-downward-dog}
**Flow:** Start in child's pose, flow to downward dog
